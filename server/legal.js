'use strict';
/* Krunxa · páginas legales (/privacidad y /terminos), con los datos del titular tomados de las variables LEGAL_OWNER, LEGAL_EMAIL y LEGAL_COUNTRY.
...
function page(title, body) {
  return '<!doctype html><html lang="es"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>' + esc(title) + ' · Krunxa</title>' +
...
<h2>1. El servicio</h2><p>Krunxa es un juego gratuito de disparos en línea ofrecido por ${d.owner}. Al crear una cuenta aceptas estos términos y la <a href="privacidad">política de privacidad</a>.</p>
